    ...
    <footer className='w-full pt-20 pb-20' id='contact'>
        ...
        <div className='flex flex-col items-center'>
            ...
            <p className='text-white-200 md:mt-10 my-5 text-center'>
                React out to me today and lets discuss how I can help you achieve your goals. 
            </p>
        ...
        <div className='flex mt-16 md:flex-row flex-col justify-between items-center'>
            <p className='md:text-base text-sm md:font-normal font-light'>Copyright © 2024 Divyansh</p>
            <div className='flex items-center md:gap-3 gap-6'>
                {socialMedia.map((profile) => (
                    <div key={profile.id} className="w-10 h-10 cursor-pointer flex justify-center items-center backdrop-filter backdrop-blur-lg saturate-180 bg-opacity-75 bg-black-200 rounded-lg border border-black-300">
                        <img src={profile.src} alt={profile.img} width={20} height={20}/>
                    </div>
                ))}
            </div>
        </div>
